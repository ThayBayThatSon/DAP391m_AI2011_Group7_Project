...
Model & MAE & RMSE & $R^2$ \\
\midrule
XGBoost & 13.7377 & 19.4397 & 0.4611 \\
LightGBM & 13.6724 & 19.4935 & 0.4581 \\
Linear Ridge & 13.6281 & 19.6278 & 0.4506 \\
Random Forest & 13.9405 & 19.8670 & 0.4371 \\
CatBoost & 13.7455 & 20.4220 & 0.4052 \\
Persistence & 16.5616 & 23.7646 & 0.1946 \\
Climatology & 19.1833 & 26.8684 & -0.0296 \\
\bottomrule
\end{tabular}
\end{table}
\FloatBarrier

The long-term task is significantly harder because local AQI observations from $t-1$ to $t-23$ are excluded. XGBoost achieves the highest $R^2$ (0.4611), but its advantage over LightGBM and Linear Ridge is small. Unlike the short-term task, the Persistence baseline collapses to an $R^2$ of 0.1946, demonstrating that AQI conditions change considerably over 24 hours. The models must therefore rely on smoother day-prior structure, seasonal timing, spatial lags, and meteorological context to outperform Persistence. Climatology again produces negative $R^2$, indicating that using long-term historical means is worse than simply predicting the global mean. Abrupt upper-tail events remain difficult to anticipate from the available tabular features alone.
...
\midrule
Short-term & Full 2025 test year & LightGBM & 26297 & 6.0778 & 9.5665 & 0.8695 \\
...
Short-term & Extreme AQI in 2025 (top 5\%) & Persistence & 1325 & 17.2006 & 23.3535 & 0.3126 \\
Short-term & July--September 2025 wildfire season & Persistence & 6624 & 5.9556 & 10.0932 & 0.8595 \\
Long-term & Full 2025 test year & XGBoost & 26297 & 13.7377 & 19.4397 & 0.4611 \\
Long-term & Non-event baseline (AQI $\leq 100$) & CatBoost & 24806 & 11.3184 & 14.5817 & 0.4325 \\
Long-term & January 2025 Winter Extreme-AQI Window & LightGBM & 1799 & 20.4529 & 33.5123 & 0.1966 \\
Long-term & Extreme AQI in 2025 (top 5\%) & Persistence & 1325 & 40.5408 & 53.4492 & -2.6009 \\
Long-term & July--September 2025 wildfire season & Random Forest & 6624 & 13.1980 & 18.9239 & 0.5061 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\midrule
Short-term & Full feature set & 47 & 6.0778 & 9.5665 & 0.8695 & -- & -- \\
Short-term & Without VPD & 46 & 6.0852 & 9.5965 & 0.8687 & 0.0074 & -0.0008 \\
Short-term & Without spatial lags & 32 & 6.1663 & 9.5742 & 0.8693 & 0.0884 & -0.0002 \\
Long-term & Full feature set & 49 & 13.6724 & 19.4935 & 0.4581 & -- & -- \\
Long-term & Without VPD & 48 & 13.6677 & 19.4654 & 0.4596 & -0.0048 & 0.0016 \\
Long-term & Without spatial lags & 34 & 13.6520 & 19.3601 & 0.4655 & -0.0205 & 0.0074 \\
\bottomrule
\end{tabular}%
}
\end{table}
